# Casino Slot Game Engine
This is a prototype casino slot game engine created by Elliott HIll using PIXI.js.
## Features
- Spinning reels of symbols.
- Abstracted configs to easily modify the size and amount of reels (modifying predefined results required).
...
## Future Features
- Handle window resizing after start up.
- Spin stages (spin kickback, landing pullback, etc.).
